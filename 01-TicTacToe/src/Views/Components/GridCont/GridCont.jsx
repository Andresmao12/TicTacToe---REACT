...
const GridCont = forwardRef(
    ({ turn, sendNewTurn, winner, sendWinner }, ref) => {
        ...
        useEffect(() => {
            ...
            if (
                !gameState?.boardState?.every((element) => element == null) &&
                gameState != null
            )
        ...
        const updateBoard = (index) => {
            ...
            window.localStorage.setItem(
                "gameState",
                JSON.stringify({ boardState: newBoard, turnState: newTurn })
            );
            ...
            } else if (tiedValidation(newBoard)) {
                //Hay empate
...
GridCont.displayName = "GridCont";

// Validar las props con PropTypes
GridCont.propTypes = {
  turn: PropTypes.isRequired, // Asegúrate de que coincida con el tipo real
  sendNewTurn: PropTypes.isRequired,
  winner: PropTypes.isRequired,
  sendWinner: PropTypes.isRequired,
};
